<ul class="nav navbar-nav navbar-nav-expanded pull-right margin-md-right">
        ...
        <ul class="dropdown-menu dropdown-messages pull-right">
            ...
            <li class="unread">
                <a href="javascript:;" class="message">
                    <img class="message-image img-circle" src="<?php echo ctConfig('upload_path'); ?>avatars/1.jpg">
            ...
            <li class="unread">
                <a href="javascript:;" class="message">
                    <img class="message-image img-circle" src="<?php echo ctConfig('upload_path'); ?>avatars/3.jpg">
            ...
            <li>
                <a href="javascript:;" class="message">
                    <img class="message-image img-circle" src="<?php echo ctConfig('upload_path'); ?>avatars/8.jpg">
            ...
            <li>
                <a href="javascript:;" class="message">
                    <img class="message-image img-circle" src="<?php echo ctConfig('upload_path'); ?>avatars/7.jpg">
    ...
    <li class="dropdown">
        <a data-toggle="dropdown" class="dropdown-toggle navbar-user" href="javascript:;">
            <img class="img-circle" src="<?php echo ctConfig('upload_path'); ?>profile.jpg">
